...
//        assertEquals(token3.getToken(), tokens.get(2).getToken());//3
        assertEquals(token4.getToken(), tokens.get(0).getToken());
        assertEquals(token4.getToken(), tokens.get(0).getToken());//4
        assertEquals(token5.getToken(), tokens.get(1).getToken());
        assertEquals(token5.getToken(), tokens.get(1).getToken());//5
        assertEquals(token6.getToken(), tokens.get(2).getToken());
        assertEquals(token6.getToken(), tokens.get(2).getToken());//6
        assertEquals(token7.getToken(), tokens.get(3).getToken());
        assertEquals(token7.getToken(), tokens.get(3).getToken());//7
        assertEquals(token8.getToken(), tokens.get(4).getToken());
        assertEquals(token8.getToken(), tokens.get(4).getToken());//8
        assertEquals(token9.getToken(), tokens.get(5).getToken());
        assertEquals(token9.getToken(), tokens.get(5).getToken());//9
    }
